                ...
                <div className={"text-spacing-wrapper is--margin-bottom-32"}>
                  <div className={"wrapper is--w-100p"}>
                    <p className={"regular-l is--w-100p is--margin-bottom-16"}>
                      {"Запрошуємо організації до вступу до спілки ЄСОП."}
                    </p>
                    <p className={"regular-l is--w-100p is--margin-bottom-16"}>
                    ...
                    <div className={"bullet-list is--margin-bottom-16"}>
                      <div className={"bullet-list__item is--w-100p"}>
                        ...
                        <p className={"regular-l is--w-100p"}>
                          {"Визнання вашої турботи про працівників, що сприяє Вашій діловій і доброчесній репутації."}
                        </p>
                      </div>
                      <div className={"bullet-list__item is--w-100p"}>
                        <div className={"bullet-list__bullet-wrapper"}>
                        ...
                        <p className={"regular-l is--w-100p"}>
                          {"Доступ до компетентних порад щодо безпеки праці."}
                        </p>
                      </div>
                      <div className={"bullet-list__item is--w-100p"}>
                        <div className={"bullet-list__bullet-wrapper"}>
                        ...
                        <p className={"regular-l is--w-100p"}>
                          {"Обмін досвідом з іноземними на вітчизняними підприємствами у галузі безпеки праці."}
                        </p>
                      </div>
                    </div>
                    <p className={"regular-l is--w-100p is--margin-bottom-16"}>
                    ...
                    <div className={"bullet-list"}>
                      <div className={"bullet-list__item is--w-100p"}>
                        ...
                        <p className={"regular-l is--w-100p"}>
                          {"Дбати про безпеку працівників та клієнтів Вашої організації."}
                        </p>
                      </div>
                      <div className={"bullet-list__item is--w-100p"}>
                        <div className={"bullet-list__bullet-wrapper"}>
                        ...
                        <p className={"regular-l is--w-100p"}>
                          {"Взаємодіяти з ЄСОП щодо удосконалення системи управління здоров’ям та безпекою на Вашому підприємстві."}
                        </p>
                      </div>
                    </div>
                  </div>
