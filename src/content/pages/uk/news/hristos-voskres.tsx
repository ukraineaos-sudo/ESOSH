        ...
        <div className={"w-layout-blockcontainer container w-container"}>
          <div className={"wrapper is--v-flex-center-top"}>
            <div className={"wrapper is--max-width-870 is--w-100p"}>
              ...
              <img className={"image is--w-100p is--height-480 is--radius-6 is--fit-cover is--margin-bottom-64--m-48"} src={"/images/news/2026-04-12-140354386-430af24a.webp"} alt={""} id={"www.esosh.net-news-esosh-pidtrimuie-globalniy-tizhden-obiznanosti-pro-azbest-yakiy-prohodit-1-7-kvitnya"} loading={"lazy"} width={1536} height={1024} decoding="async" />
              <div className={"rich-news-text w-richtext"}>
                <h3>
                  {"Нехай цей Великдень принесе у ваш дім мир, тепло та впевненість у завтрашньому дні.Бажаємо безпеки в роботі, турботи в колективі та спокою в серці. "}
                </h3>
                <h3>
                  {"Світлих і безпечних свят вам та вашим родинам!"}
                </h3>
                <h3>
                  {"З Великоднем від команди ESOSH 🐣"}
                </h3>
              </div>
            </div>
          </div>
          ...
          <div className={"collection-list-wrapper w-dyn-list"}>
            <div role={"list"} className={"collection-list is--grid-3-columns--a-1-column w-dyn-items"}>
              ...
              <div role={"listitem"} className={"collection-item w-dyn-item"}>
                <a href={"#"} className={"collection-link-wrapper w-inline-block"}>
                  <div className={"collection-image-wrapper is--height-240--t-360--m-240 is--margin-bottom-20--m-16 is--overflow-hidden"}>
                    <img loading={"lazy"} alt={"Вакансія: Інженер з охорони праці "} src={"/images/news/2026-04-15-150045432-ae172cbd.webp"} className={"collection-image"} width={1536} height={1024} decoding="async" />
                  </div>
                  <div className={"collection-text-wrapper is--max-width-408--a-664 is--padding-right-24--m-0"}>
                    <h3 className={"h3 is--margin-bottom-12"}>
