            ...
            <div className={"wrapper is--max-width-870 is--w-100p"}>
              ...
              <div className={"wrapper is--margin-bottom-64--m-48"}>
                <h1 className={"h1 is--margin-bottom-16"}>
                  {"Зустрінемося на міжнародному форумі 2026"}
                </h1>
                <div className={"regular-s is--grey-20"}>
                  {"2.4.2026"}
                </div>
              </div>
              <img className={"image is--w-100p is--height-480 is--radius-6 is--fit-cover is--margin-bottom-64--m-48"} src={"/images/news/IMG-0018-1-adbd53ca.webp"} alt={""} id={"www.esosh.net-news-esosh-pidtrimuie-globalniy-tizhden-obiznanosti-pro-azbest-yakiy-prohodit-1-7-kvitnya"} loading={"lazy"} width={1920} height={1080} decoding="async" />
              <div className={"rich-news-text w-richtext"}>
                <h4>
                  {"🔹 26–28 травня 2026 | Київ, Міжнародний виставковий центр"}
                </h4>
                <h4>
                  {"ESOSH бере участь у XXIV Міжнародному промисловому форумі – найбільшій промисловій виставці України."}
                </h4>
                <h4>
                  {"Запрошуємо з нами!"}
                </h4>
                ...
                <h4>
                  {"⚙ Провідні промислові підприємства України та світу"}
                </h4>
                <h4>
                  {"🤖 Новітні технології, обладнання та інструменти"}
                </h4>
                <h4>
                  {"🔧 Спеціалізовані виставки: металообробка, зварювання, автоматизація, робототехніка та багато іншого"}
                </h4>
                <h4>
                  {"📚 Конференції, семінари та презентації учасників"}
                </h4>
                <h4>
                  {"Для відвідувачів – унікальна можливість:"}
                </h4>
                <h4>
                  {"✨ Познайомитися з ключовими гравцями ринку"}
                </h4>
                <h4>
                  {"✨ Обговорити партнерство та нові проєкти"}
                </h4>
                <h4>
                  {"✨ Ознайомитися з передовими технологіями"}
                </h4>
                <h4>
                  {"✅ Вхід безкоштовний, реєстрація обов’язкова"}
                </h4>
                <h4>
                  {"З тематикою виставки можна ознайомитись за "}
                  <a href={"https://fire-expo.com.ua/pro-vystavku/tm.html"}>
                    {"посиланням"}
                  </a>
                </h4>
                <p>
          ...
          <div className={"collection-list-wrapper w-dyn-list"}>
            <div role={"list"} className={"collection-list is--grid-3-columns--a-1-column w-dyn-items"}>
              ...
              <div role={"listitem"} className={"collection-item w-dyn-item"}>
                <a href={"#"} className={"collection-link-wrapper w-inline-block"}>
                  <div className={"collection-image-wrapper is--height-240--t-360--m-240 is--margin-bottom-20--m-16 is--overflow-hidden"}>
                    <img loading={"lazy"} alt={"Вакансія: Керівник відділу охорони праці  "} src={"/images/news/2026-04-15-145713592-d89c8406.webp"} className={"collection-image"} width={1536} height={1024} decoding="async" />
                  </div>
                  <div className={"collection-text-wrapper is--max-width-408--a-664 is--padding-right-24--m-0"}>
                    <h3 className={"h3 is--margin-bottom-12"}>
                      {"Вакансія: Керівник відділу охорони праці  "}
                    </h3>
                    <div className={"regular-xs is--grey-20"}>
                      {"4.5.2026"}
                    </div>
              ...
              <div role={"listitem"} className={"collection-item w-dyn-item"}>
                <a href={"#"} className={"collection-link-wrapper w-inline-block"}>
                  <div className={"collection-image-wrapper is--height-240--t-360--m-240 is--margin-bottom-20--m-16 is--overflow-hidden"}>
                    <img loading={"lazy"} alt={"Презентуємо програму «Захист лева»"} src={"/images/news/2026-05-21-161712035-fdf848ee.webp"} className={"collection-image"} width={1920} height={1080} decoding="async" />
                  </div>
                  <div className={"collection-text-wrapper is--max-width-408--a-664 is--padding-right-24--m-0"}>
                    <h3 className={"h3 is--margin-bottom-12"}>
                      {"Презентуємо програму «Захист лева»"}
                    </h3>
                    <div className={"regular-xs is--grey-20"}>
                      {"6.7.2026"}
                    </div>
