        ...
        <div className={"w-layout-blockcontainer container w-container"}>
          <div className={"wrapper is--v-flex-center-top"}>
            <div className={"wrapper is--max-width-870 is--w-100p"}>
              ...
              <img id={"www.esosh.net-news-esosh-pidtrimuie-globalniy-tizhden-obiznanosti-pro-azbest-yakiy-prohodit-1-7-kvitnya"} alt={""} loading={"lazy"} src={"/images/news/IMG-0017-3-c2fd3ce0.webp"} className={"image is--w-100p is--height-480 is--radius-6 is--fit-cover is--margin-bottom-64--m-48"} width={1920} height={1080} decoding="async" />
              <div className={"rich-news-text w-richtext"}>
                <h3>
                  {"You enter the profession, place and type of work 👉 you get in a few minutes:"}
                </h3>
                <h3>
                  {"✅ ready-made table with risks and safety measures"}
                </h3>
                <h3>
                  {"✅ educational presentation"}
                </h3>
                <h3>
                  {"✅ test to test knowledge"}
                </h3>
                <h3>
                  {"And this is in two languages: Ukrainian and English!"}
                </h3>
                <h3>
                  {"⏱ Minutes instead of hours of work with tables."}
                </h3>
                <h3>
                  {"🔒 European security standards in Ukrainian software."}
                </h3>
                <h3>
                  {"🎯 For managers, occupational health professionals, contractors and teachers."}
                </h3>
                <h3>
                  {"🌐 "}
                  <a href={"https://eriskcontrol.com/uk/login"}>
                    {"Demo"}
                  </a>
                </h3>
                <h3>
                  {"🎁 First 3 risk assessments — free!"}
                </h3>
                <h3>
                  {"💳 Cost from 9 UAH/month."}
                </h3>
                <h3>
                  {"eRisk-Control — free up time for true security!"}
                </h3>
                <h3>
                  {"Developer ESOSH "}
                </h3>
                <h3>
                  {"To order, write to our mail: office@esosh.net"}
                </h3>
                <p>
                  {"‍"}
                </p>
          ...
          <div className={"collection-list-wrapper w-dyn-list"}>
            <div role={"list"} className={"collection-list is--grid-3-columns--a-1-column w-dyn-items"}>
              ...
              <div role={"listitem"} className={"collection-item w-dyn-item"}>
                <a href={"#"} className={"collection-link-wrapper w-inline-block"}>
                  <div className={"collection-image-wrapper is--height-240--t-360--m-240 is--margin-bottom-20--m-16 is--overflow-hidden"}>
                    <img loading={"lazy"} alt={"Blind barrier-free zones: what does business not see?"} src={"/images/news/2026-05-01-160411053-a0d3089d.webp"} className={"collection-image"} width={1920} height={1080} decoding="async" />
                  </div>
                  <div className={"collection-text-wrapper is--max-width-408--a-664 is--padding-right-24--m-0"}>
                    <h3 className={"h3 is--margin-bottom-12"}>
                      {"Blind barrier-free zones: what does business not see?"}
                    </h3>
                    <div className={"regular-xs is--grey-20"}>
                      {"4.5.2026"}
                    </div>
